...
namespace WebApplication4.Models
{
    ...
    public class Balance_Model
    {
        ...
        public string card { get; set; } = "0000000000000000";
    ...
    public class Saldo_Req
    {
        ...
        public string Id_Cve_TokenCta { get; set; }
        public string Cve_Operacion { get; set; }
        public decimal Imp_Vta { get; set; }
        public int Cant_Puntos { get; set; }
        public decimal Imp_Comp { get; set; }
        public decimal Imp_DE { get; set; }
        public decimal Imp_Efvo { get; set; }
        public decimal Imp_Cred { get; set; }
